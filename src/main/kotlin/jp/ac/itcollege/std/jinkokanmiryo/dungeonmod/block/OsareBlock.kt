...
object OsareBlock: Block(Material.ROCK) {
    init {
        // クリエイティブタブ
        ...
        this.unlocalizedName = "osare_block"
        this.registryName = ResourceLocation(DungeonMod.ID, "osare_block")
